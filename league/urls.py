...
from league.views import (
    ...
    get_league_user_detail,
    get_season_user_detail,
    get_tournament_user_detail,
    calendar
)
...
urlpatterns = [
    ...
    path('manager/league_user_detail/<int:league_id>', get_league_user_detail, name='league_user_detail'),
    path('manager/season_detail/<int:season_id>', get_season_detail, name='season_detail'),
    path('manager/season_user_detail/<int:season_id>', get_season_user_detail, name='season_user_detail'),
    path('manager/tournament_detail/<int:tournament_id>', get_tournament_detail, name='tournament_detail'),
    path('manager/tournament_user_detail/<int:tournament_id>', get_tournament_user_detail, name='tournament_user_detail'),
